    ...
    void showMyGame(){
        ...
        for (int row = 0; row < array2d.length; row++) {
            for (int column = 0; column < array2d[0].length; column++) {
                ...
                java.net.URL imgURL = App.class.getResource("img/pintu_"+String.valueOf(array2d[row][column])+".png");
